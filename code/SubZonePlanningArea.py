#to scrape subzone and planning area data from OneMap 
...
with open('/Users/VishnuGT/Programming/PythonPrograms/XY_Nodes_2.csv', 'rb') as f:
    reader = csv.reader(f)
    busnodes_xy_list = list(reader)

#print busnodes_xy_list
#open a cursor to csv
with open('/Users/VishnuGT/Programming/PythonPrograms/Sub_Planning.csv','wb') as f1:
